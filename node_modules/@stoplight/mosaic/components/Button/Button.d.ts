...
} & BorderWidthProps & BorderRoundedProps & import("../../enhancers").IRingProps & import("../../enhancers").IInteractivityProps & import("../../enhancers").IFlexProps & import("../../enhancers").IPositionProps & import("../../enhancers").TransformProps & import("../../enhancers").ILayoutProps & {
    as?: T;
    className?: string;
    role?: string;
    noFocusRing?: boolean;
    children?: React.ReactNode;
} & Omit<React.ComponentProps<T>, keyof BorderWidthProps | keyof BorderRoundedProps | "icon" | "children" | "className" | "role" | "label" | keyof import("../../enhancers").ITypographyProps | keyof import("../../enhancers").ISizeProps | keyof import("../../enhancers").IMarginProps | keyof import("../../enhancers").IPaddingProps | "boxShadow" | keyof import("../../enhancers").IColorProps | "outline" | "borderColor" | keyof import("../../enhancers").IRingProps | keyof import("../../enhancers").IInteractivityProps | keyof import("../../enhancers").IFlexProps | keyof import("../../enhancers").IPositionProps | keyof import("../../enhancers").TransformProps | keyof import("../../enhancers").ILayoutProps | "as" | "noFocusRing" | keyof PressEvents | keyof FocusableProps | "appearance" | "intent" | "size" | "active" | "disabled" | "loading" | "iconRight" | "fullWidth"> & {
