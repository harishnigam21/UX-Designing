...
declare const _CopyButton: React.ForwardRefExoticComponent<{
    copyValue: string;
} & import("@react-types/shared").PressEvents & import("@react-types/shared").FocusableProps & Omit<import("../..").BorderWidthProps, "border"> & Omit<import("../..").BorderRoundedProps, "rounded"> & {
