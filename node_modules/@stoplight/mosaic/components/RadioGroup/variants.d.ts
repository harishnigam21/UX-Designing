import { FontSizeVals, HeightVals, IColorProps, IntentVals, ITypographyProps, SemanticColorVals, TextColorVals } from '../../enhancers';
export declare type StrokeColorVals = 'text' | SemanticColorVals;
