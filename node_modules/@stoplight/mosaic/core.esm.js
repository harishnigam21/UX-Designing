...
function $3ef42575df84b30b$export$9d1611c77c2fe928$2(...args) {
    ...
    for(let i = 1; i < args.length; i++){
        ...
        for(let key in props){
            ...
            else if ((key === 'className' || key === 'UNSAFE_className') && typeof a === 'string' && typeof b === 'string') result[key] = cn(a, b);
...
const useSafeEffect = typeof window !== 'undefined' && !process.env.TEST_SSR ? useLayoutEffect$1 : useEffect;
...
const AvatarList = function AvatarList(props) {
  ...
  const WrapperElem = React.useMemo(() => /*#__PURE__*/React.forwardRef((wrapperProps, wrapperRef) => {
...
const Badge = /*#__PURE__*/React.memo( /*#__PURE__*/forwardRef(function Input({
  appearance = 'solid',
  size = 'md',
  as = defaultElement$6,
  className,
